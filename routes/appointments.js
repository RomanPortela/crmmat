...
router.post('/', async (req, res) => {
  try {
    const {
      ...
      product_interested, has_trade_in, notes, seña_paid
    } = req.body;
    ...
    `, [contact_id, conversation_id, scheduled_at, product_interested, has_trade_in, notes, seña_paid || false]);
...
router.patch('/:id', async (req, res) => {
  try {
    const { id } = req.params;
    const { scheduled_at, status, notes, seña_paid, product_interested } = req.body;
    ...
    `, [scheduled_at, status, notes, seña_paid, product_interested, id]);
